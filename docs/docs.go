                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.SendVerificationRequest"
                        }
                    }
                ],
                "responses": {
